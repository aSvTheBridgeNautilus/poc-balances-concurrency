...
@Configuration
@EnableAsync
public class BillingPeriodAsyncConfiguration implements AsyncConfigurer {
	...
	public Executor taskExecutor() {
		log.debug(
				"[BillingPeriodAsyncConfiguration:taskExecutor] Creating async task executor to manage Billing Periods");
